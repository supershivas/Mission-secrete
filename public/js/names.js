...
const ADJ_ALL = [
  "ACIER","AIGLE","ARGENT","AMBRE","APEX","ASTRAL",
  "BLIZZARD","BRONZE",
  "COBRA","CYCLONE","CENDRE","CRISTAL",
  "DAUPHIN","DRAGON",
  "ÉCLAIR","ÉTOILE","EMPIRE",
  "FANTÔME","FURTIF","FALCON","FÉLIN",
  "GLACIAL","GRIFFON","GRANITE","GUÉPARD",
  "HIBOU","HYDRE",
  "INVINCIBLE","INFERNO","IMPÉRIAL","INDIGO",
  "JADE","JAGUAR","JAVELIN",
  "KRAKEN","KRYPTON",
  "LOUP","LYNX",
  "MERCURE","MYSTÈRE","MINUIT","MANTICORE",
  "NOIR","NEXUS",
  "OMBRE","ORAGE","ONYX","OBSIDIENNE",
  "PYTHON","PUMA","PANTHER","PLASMA",
  "QUANTUM",
  "RAPIDE","RENARD","ROUGE","RAPTOR",
  "SILENCIEUX","SPECTRE","SOLAIRE","SPHINX",
  "TITAN","TORNADE","TEMPÊTE","TALON",
  "URANIUM","ULTRA",
  "VIPÈRE","VORTEX","VALIANT",
  "XENON",
  "ZÉNITH",
